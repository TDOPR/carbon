...
public class TronUiltNew {
    ...
    public static TronUiltNew.BroadcastResultBean sendTrxTransaction(String from, String prikey, String to, long value) throws Exception {
        ...
        if (Strings.isBlank(blockStr)) {
            ...
            return (TronUiltNew.BroadcastResultBean) JSON.parseObject(broadcastResult, TronUiltNew.BroadcastResultBean.class);
        }
    }

    public static TronUiltNew.BroadcastResultBean sendContractTransaction(String from, String prikey, String contractAddr, String method, List<Object> args) throws Exception {
        byte[] privateBytes = org.tron.common.utils.ByteArray.fromHexString(prikey);
        String blockStr = doGet(URL_LAST_BLOCK);
        if (Strings.isBlank(blockStr)) {
            throw new Exception("获取最新区块出错");
    ...
    public static class BlockBeanHeader {
        public TronUiltNew.BlockBeanRaw raw_data;
    ...
    public static class BlockResultBean {
        ...
        public TronUiltNew.BlockBeanHeader block_header;
